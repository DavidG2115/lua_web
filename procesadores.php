...
<?php if (!empty($user)): ?>
	...
	<section id="info">
		<div class="container-items">
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/p1.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador AMD RYZEN 7 5700G APU 3.8GHZ</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/p2.png" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador AMD Ryzen 5 5600</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/r7-5.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador AMD Ryzen 7 5800X</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/p2.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador Intel Core i5-13600K 5.10 GHz</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/p7.png" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador Intel Core i5-13400</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/procesadores/p8.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Procesador Intel Core i3-12100 3.3GHz</h2>
