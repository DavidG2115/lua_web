...
<?php if (!empty($user)): ?>
	...
	<section id="info">
		<div class="container-items">
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m1.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Asus PRIME A320M-K Socket AM4</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m2.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Asus PRIME B550M-A AC </h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m4.png" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Gigabyte B550M DS3H AC SOCKET</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m5.png" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Asus PRIME H610M-E D4</h2>
					<p class="price">$2049</p>
					<button class="btn-add-cart">Añadir al carrito</button>
				</div>
			</div>
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m6.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Gigabyte B550 AORUS ELITE AX</h2>
			...
			<div class="item">
				<figure>
					<img src="imagenes/mothers/m8.jpg" alt="producto" />
				</figure>
				<div class="info-product">
					<h2>Tarjeta Madre Asus ROG STRIX B550-F GAMING WIFI</h2>
					<p class="price">$2099</p>
					<button class="btn-add-cart">Añadir al carrito</button>
				</div>
			</div>
